...
__decorate$1([attr], Avatar.prototype, "fill", void 0);
__decorate$1([attr], Avatar.prototype, "color", void 0);
__decorate$1([attr], Avatar.prototype, "link", void 0);
__decorate$1([attr], Avatar.prototype, "shape", void 0);
...
__decorate$1([attr], Button.prototype, "formaction", void 0);
__decorate$1([attr], Button.prototype, "formenctype", void 0);
__decorate$1([attr], Button.prototype, "formmethod", void 0);
__decorate$1([attr({
  mode: "boolean"
})], Button.prototype, "formnovalidate", void 0);
__decorate$1([attr], Button.prototype, "formtarget", void 0);
__decorate$1([attr], Button.prototype, "type", void 0);
__decorate$1([observable], Button.prototype, "defaultSlottedContent", void 0);
/**
...
__decorate$1([observable], Combobox.prototype, "maxHeight", void 0);
__decorate$1([attr({
  attribute: "open",
  mode: "boolean"
})], Combobox.prototype, "open", void 0);
__decorate$1([attr], Combobox.prototype, "placeholder", void 0);
__decorate$1([attr({
  attribute: "position"
})], Combobox.prototype, "positionAttribute", void 0);
__decorate$1([observable], Combobox.prototype, "position", void 0);
/**
...
__decorate$1([attr], Disclosure.prototype, "title", void 0);
...
__decorate$1([observable], PickerMenu.prototype, "menuElements", void 0);
__decorate$1([observable], PickerMenu.prototype, "headerElements", void 0);
__decorate$1([observable], PickerMenu.prototype, "footerElements", void 0);
__decorate$1([observable], PickerMenu.prototype, "suggestionsAvailableText", void 0);
...
__decorate$1([observable], Menu.prototype, "items", void 0);
...
__decorate$1([attr], TextField.prototype, "placeholder", void 0);
__decorate$1([attr], TextField.prototype, "type", void 0);
__decorate$1([attr], TextField.prototype, "list", void 0);
__decorate$1([attr({
  converter: nullableNumberConverter
...
__decorate$1([attr], TextField.prototype, "pattern", void 0);
__decorate$1([attr({
  converter: nullableNumberConverter
...
__decorate$1([observable], TextField.prototype, "defaultSlottedNodes", void 0);
/**
...
__decorate$1([attr], NumberField.prototype, "placeholder", void 0);
__decorate$1([attr], NumberField.prototype, "list", void 0);
__decorate$1([attr({
  converter: nullableNumberConverter
...
__decorate$1([observable], NumberField.prototype, "defaultSlottedNodes", void 0);
...
__decorate$1([attr], Search.prototype, "placeholder", void 0);
__decorate$1([attr], Search.prototype, "list", void 0);
__decorate$1([attr({
  converter: nullableNumberConverter
...
__decorate$1([attr], Search.prototype, "pattern", void 0);
__decorate$1([attr({
  converter: nullableNumberConverter
...
__decorate$1([observable], Search.prototype, "defaultSlottedNodes", void 0);
/**
 * Includes ARIA states and properties relating to the ARIA textbox role
 *
 * @public
...
__decorate$1([attr], TextArea.prototype, "resize", void 0);
__decorate$1([attr({
  mode: "boolean"
...
__decorate$1([attr], TextArea.prototype, "list", void 0);
__decorate$1([attr({
  converter: nullableNumberConverter
...
__decorate$1([attr], TextArea.prototype, "name", void 0);
__decorate$1([attr], TextArea.prototype, "placeholder", void 0);
__decorate$1([attr({
  converter: nullableNumberConverter,
  mode: "fromView"
...
__decorate$1([observable], TextArea.prototype, "defaultSlottedNodes", void 0);
...
function binarySearch(valuesToSearch, searchCondition, startIndex = 0, endIndex = valuesToSearch.length - 1) {
  ...
  ) : binarySearch(valuesToSearch, searchCondition, middleIndex + 1,
 ...
 * @private
 */
const elementScale = create('element-scale').withDefault(0);
/** @public */
...
/** @public */
const foregroundOnAccentFocusLarge = create('foreground-on-accent-focus-large').withDefault(element => foregroundOnAccentLargeRecipe.getValueFor(element).evaluate(element, accentFillFocus.getValueFor(element)));
// Accent Foreground
 ...
 */
/** @public */
const errorColor = create('error-color').withDefault(errorBase);
/**
 * Error palette
 * @public
 */
...
/** @public */
const errorFillRest = create('error-fill-rest').withDefault(element => {
  return errorFillRecipe.getValueFor(element).evaluate(element).rest;
});
/** @public */
const errorFillHover = create('error-fill-hover').withDefault(element => {
  return errorFillRecipe.getValueFor(element).evaluate(element).hover;
});
/** @public */
const errorFillActive = create('error-fill-active').withDefault(element => {
  return errorFillRecipe.getValueFor(element).evaluate(element).active;
});
/** @public */
const errorFillFocus = create('error-fill-focus').withDefault(element => {
...
/** @public */
const foregroundOnErrorRecipe = create({
...
/** @public */
const foregroundOnErrorRest = create('foreground-on-error-rest').withDefault(element => foregroundOnErrorRecipe.getValueFor(element).evaluate(element, errorFillRest.getValueFor(element)));
/** @public */
const foregroundOnErrorHover = create('foreground-on-error-hover').withDefault(element => foregroundOnErrorRecipe.getValueFor(element).evaluate(element, errorFillHover.getValueFor(element)));
/** @public */
const foregroundOnErrorActive = create('foreground-on-error-active').withDefault(element => foregroundOnErrorRecipe.getValueFor(element).evaluate(element, errorFillActive.getValueFor(element)));
/** @public */
const foregroundOnErrorFocus = create('foreground-on-error-focus').withDefault(element => foregroundOnErrorRecipe.getValueFor(element).evaluate(element, errorFillFocus.getValueFor(element)));
/** @public */
const foregroundOnErrorLargeRecipe = create({
...
/** @public */
const foregroundOnErrorRestLarge = create('foreground-on-error-rest-large').withDefault(element => foregroundOnErrorLargeRecipe.getValueFor(element).evaluate(element, errorFillRest.getValueFor(element)));
/** @public */
const foregroundOnErrorHoverLarge = create('foreground-on-error-hover-large').withDefault(element => foregroundOnErrorLargeRecipe.getValueFor(element).evaluate(element, errorFillHover.getValueFor(element)));
/** @public */
const foregroundOnErrorActiveLarge = create('foreground-on-error-active-large').withDefault(element => foregroundOnErrorLargeRecipe.getValueFor(element).evaluate(element, errorFillActive.getValueFor(element)));
/** @public */
const foregroundOnErrorFocusLarge = create('foreground-on-error-focus-large').withDefault(element => foregroundOnErrorLargeRecipe.getValueFor(element).evaluate(element, errorFillFocus.getValueFor(element)));
// Error Foreground
...
/** @public */
const errorForegroundRecipe = create({
...
/** @public */
const errorForegroundRest = create('error-foreground-rest').withDefault(element => errorForegroundRecipe.getValueFor(element).evaluate(element).rest);
/** @public */
const errorForegroundHover = create('error-foreground-hover').withDefault(element => errorForegroundRecipe.getValueFor(element).evaluate(element).hover);
/** @public */
const errorForegroundActive = create('error-foreground-active').withDefault(element => errorForegroundRecipe.getValueFor(element).evaluate(element).active);
/** @public */
const errorForegroundFocus = create('error-foreground-focus').withDefault(element => errorForegroundRecipe.getValueFor(element).evaluate(element).focus);
...
__decorate([attr], JupyterAnchor.prototype, "appearance", void 0);
/**
...
__decorate([attr], JupyterAvatar.prototype, "alt", void 0);
/**
...
__decorate([attr], JupyterButton.prototype, "appearance", void 0);
__decorate([attr({
  attribute: 'minimal',
  mode: 'boolean'
})], JupyterButton.prototype, "minimal", void 0);
__decorate([attr], JupyterButton.prototype, "scale", void 0);
/**
...
class JupyterCombobox extends Combobox {
  ...
  updateComputedStylesheet() {
    ...
    this.computedStylesheet = css` :host{--listbox-max-height: ${popupMaxHeight}}`;
...
__decorate([attr], JupyterCombobox.prototype, "scale", void 0);
/**
...
__decorate([attr], DateField.prototype, "appearance", void 0);
__decorate([attr({
  attribute: 'readonly',
  mode: 'boolean'
...
__decorate([attr], DateField.prototype, "list", void 0);
__decorate([attr({
  converter: nullableNumberConverter
})], DateField.prototype, "step", void 0);
__decorate([attr({
  converter: nullableDateConverter
})], DateField.prototype, "max", void 0);
__decorate([attr({
  converter: nullableDateConverter
})], DateField.prototype, "min", void 0);
__decorate([observable], DateField.prototype, "defaultSlottedNodes", void 0);
 ...
 * @public
 */
const dateFieldStyles = (context, definition) => css` ${BaseFieldStyles}`;
 ...
 * @public
 */
const dateFieldTemplate = (context, definition) => html`<template class="${x => x.readOnly ? 'readonly' : ''}"><label part="label" for="control" class="${x => x.defaultSlottedNodes && x.defaultSlottedNodes.length ? 'label' : 'label label__hidden'}"><slot ${slotted({
  property: 'defaultSlottedNodes',
  filter: whitespaceFilter
})}></slot></label><div class="root" part="root">${startSlotTemplate(context, definition)}<input class="control" part="control" id="control" @input="${x => x.handleTextInput()}" @change="${x => x.handleChange()}" ?autofocus="${x => x.autofocus}" ?disabled="${x => x.disabled}" list="${x => x.list}" ?readonly="${x => x.readOnly}" ?required="${x => x.required}" :value="${x => x.value}" type="date" aria-atomic="${x => x.ariaAtomic}" aria-busy="${x => x.ariaBusy}" aria-controls="${x => x.ariaControls}" aria-current="${x => x.ariaCurrent}" aria-describedby="${x => x.ariaDescribedby}" aria-details="${x => x.ariaDetails}" aria-disabled="${x => x.ariaDisabled}" aria-errormessage="${x => x.ariaErrormessage}" aria-flowto="${x => x.ariaFlowto}" aria-haspopup="${x => x.ariaHaspopup}" aria-hidden="${x => x.ariaHidden}" aria-invalid="${x => x.ariaInvalid}" aria-keyshortcuts="${x => x.ariaKeyshortcuts}" aria-label="${x => x.ariaLabel}" aria-labelledby="${x => x.ariaLabelledby}" aria-live="${x => x.ariaLive}" aria-owns="${x => x.ariaOwns}" aria-relevant="${x => x.ariaRelevant}" aria-roledescription="${x => x.ariaRoledescription}" ${ref('control')} />${endSlotTemplate(context, definition)}</div></template>`;
...
__decorate([attr({
  ...
  converter: swatchConverter,
  mode: 'fromView'
}), designToken(errorColor)], DesignSystemProvider.prototype, "errorColor", void 0);
__decorate([attr({
  converter: nullableNumberConverter
 ...
 * @public
 */
const designSystemProviderStyles = (context, definition) => css` ${display('block')}`;
/**
...
__decorate([attr], JupyterDisclosure.prototype, "appearance", void 0);
/**
...
class JupyterListbox extends ListboxElement {
  ...
  updateComputedStylesheet() {
    ...
    this.computedStylesheet = css` :host{--size: ${listboxSize}}`;
    this.$fastController.addStyles(this.computedStylesheet);
  }
}
/**
 ...
 * @public
 */
const numberFieldStyles = (context, definition) => css` ${BaseFieldStyles} .controls{opacity: 0}.step-up-glyph, .step-down-glyph{display: block;padding: 4px 10px;cursor: pointer}.step-up-glyph:before, .step-down-glyph:before{content: '';display: block;border: solid transparent 6px}.step-up-glyph:before{border-bottom-color: ${neutralForegroundRest}}.step-down-glyph:before{border-top-color: ${neutralForegroundRest}}:host(:hover:not([disabled])) .controls, :host(:focus-within:not([disabled])) .controls{opacity: 1}`;
...
__decorate([attr], JupyterNumberField.prototype, "appearance", void 0);
/**
 ...
 * @public
 */
const radioStyles = (context, definition) => css` ${display('inline-flex')} :host{--input-size: calc((${heightNumber} / 2) + ${designUnit});align-items: center;outline: none;margin: calc(${designUnit} * 1px) 0;/* Chromium likes to select label text or the default slot when the radio is clicked. Maybe there is a better solution here? */ user-select: none;position: relative;flex-direction: row;transition: all 0.2s ease-in-out}.control{position: relative;width: calc((${heightNumber} / 2 + ${designUnit}) * 1px);height: calc((${heightNumber} / 2 + ${designUnit}) * 1px);box-sizing: border-box;border-radius: 999px;border: calc(${strokeWidth} * 1px) solid ${neutralStrokeRest};background: ${neutralFillInputRest};outline: none;cursor: pointer}:host([aria-invalid='true']) .control{border-color: ${errorFillRest}}.label{font-family: ${bodyFont};color: ${neutralForegroundRest};padding-inline-start: calc(${designUnit} * 2px + 2px);margin-inline-end: calc(${designUnit} * 2px + 2px);cursor: pointer;font-size: ${typeRampBaseFontSize};line-height: ${typeRampBaseLineHeight}}.label__hidden{display: none;visibility: hidden}.control, .checked-indicator{flex-shrink: 0}.checked-indicator{position: absolute;top: 5px;left: 5px;right: 5px;bottom: 5px;border-radius: 999px;display: inline-block;background: ${foregroundOnAccentRest};fill: ${foregroundOnAccentRest};opacity: 0;pointer-events: none}:host(:not([disabled])) .control:hover{background: ${neutralFillInputHover};border-color: ${neutralStrokeHover}}:host([aria-invalid='true']:not([disabled])) .control:hover{border-color: ${errorFillHover}}:host(:not([disabled])) .control:active{background: ${neutralFillInputActive};border-color: ${neutralStrokeActive}}:host([aria-invalid='true']:not([disabled])) .control:active{border-color: ${errorFillActive}}:host(:${focusVisible}) .control{outline: solid calc(${focusStrokeWidth} * 1px) ${accentFillFocus}}:host([aria-invalid='true']:${focusVisible}) .control{outline-color: ${errorFillFocus}}:host([aria-checked='true']) .control{background: ${accentFillRest};border: calc(${strokeWidth} * 1px) solid ${accentFillRest}}:host([aria-invalid='true'][aria-checked='true']) .control{background-color: ${errorFillRest};border-color: ${errorFillRest}}:host([aria-checked='true']:not([disabled])) .control:hover{background: ${accentFillHover};border: calc(${strokeWidth} * 1px) solid ${accentFillHover}}:host([aria-invalid='true'][aria-checked='true']:not([disabled])) .control:hover{background-color: ${errorFillHover};border-color: ${errorFillHover}}:host([aria-checked='true']:not([disabled])) .control:hover .checked-indicator{background: ${foregroundOnAccentHover};fill: ${foregroundOnAccentHover}}:host([aria-checked='true']:not([disabled])) .control:active{background: ${accentFillActive};border: calc(${strokeWidth} * 1px) solid ${accentFillActive}}:host([aria-invalid='true'][aria-checked='true']:not([disabled])) .control:active{background-color: ${errorFillActive};border-color: ${errorFillActive}}:host([aria-checked='true']:not([disabled])) .control:active .checked-indicator{background: ${foregroundOnAccentActive};fill: ${foregroundOnAccentActive}}:host([aria-checked="true"]:${focusVisible}:not([disabled])) .control{outline-offset: 2px;outline: solid calc(${focusStrokeWidth} * 1px) ${accentFillFocus}}:host([aria-invalid='true'][aria-checked="true"]:${focusVisible}:not([disabled])) .control{outline-color: ${errorFillFocus}}:host([disabled]) .label, :host([readonly]) .label, :host([readonly]) .control, :host([disabled]) .control{cursor: ${disabledCursor}}:host([aria-checked='true']) .checked-indicator{opacity: 1}:host([disabled]){opacity: ${disabledOpacity}}`.withBehaviors(forcedColorsStylesheetBehavior(css` .control, :host([aria-checked='true']:not([disabled])) .control{forced-color-adjust: none;border-color: ${SystemColors.FieldText};background: ${SystemColors.Field}}:host([aria-invalid='true']){border-style: dashed}:host(:not([disabled])) .control:hover{border-color: ${SystemColors.Highlight};background: ${SystemColors.Field}}:host([aria-checked='true']:not([disabled])) .control:hover, :host([aria-checked='true']:not([disabled])) .control:active{border-color: ${SystemColors.Highlight};background: ${SystemColors.Highlight}}:host([aria-checked='true']) .checked-indicator{background: ${SystemColors.Highlight};fill: ${SystemColors.Highlight}}:host([aria-checked='true']:not([disabled])) .control:hover .checked-indicator, :host([aria-checked='true']:not([disabled])) .control:active .checked-indicator{background: ${SystemColors.HighlightText};fill: ${SystemColors.HighlightText}}:host(:${focusVisible}) .control{border-color: ${SystemColors.Highlight};outline-offset: 2px;outline: solid calc(${focusStrokeWidth} * 1px) ${SystemColors.FieldText}}:host([aria-checked="true"]:${focusVisible}:not([disabled])) .control{border-color: ${SystemColors.Highlight};outline: solid calc(${focusStrokeWidth} * 1px) ${SystemColors.FieldText}}:host([disabled]){forced-color-adjust: none;opacity: 1}:host([disabled]) .label{color: ${SystemColors.GrayText}}:host([disabled]) .control, :host([aria-checked='true'][disabled]) .control:hover, .control:active{background: ${SystemColors.Field};border-color: ${SystemColors.GrayText}}:host([disabled]) .checked-indicator, :host([aria-checked='true'][disabled]) .control:hover .checked-indicator{fill: ${SystemColors.GrayText};background: ${SystemColors.GrayText}}`));

// Copyright (c) Jupyter Development Team.
const radioTemplate = (context, definition) => html`<template role="radio" aria-checked="${x => x.checked}" aria-required="${x => x.required}" aria-disabled="${x => x.disabled}" aria-readonly="${x => x.readOnly}" @keypress="${(x, c) => x.keypressHandler(c.event)}" @click="${(x, c) => x.clickHandler(c.event)}"><div part="control" class="control"><slot name="checked-indicator">${definition.checkedIndicator || ''}</slot></div><label part="label" class="${x => x.defaultSlottedNodes && x.defaultSlottedNodes.length ? 'label' : 'label label__hidden'}"><slot ${slotted('defaultSlottedNodes')}></slot></label></template>`;
/**
 * Radio class
 * @public
 * @tagname jp-radio
...
__decorate([attr], JupyterSearch.prototype, "appearance", void 0);
/**
...
class JupyterSelect extends Select {
  ...
  updateComputedStylesheet() {
    ...
    this.computedStylesheet = css` :host{--listbox-max-height: ${this.listboxMaxHeight};--listbox-scroll-width: ${this.listboxScrollWidth};--size: ${this.selectSize}}`;
    this.$fastController.addStyles(this.computedStylesheet);
  }
}
__decorate([attr({
...
__decorate([attr], JupyterSelect.prototype, "scale", void 0);
__decorate([observable], JupyterSelect.prototype, "listboxScrollWidth", void 0);
/**
 ...
 * @public
 */
const horizontalSliderLabelStyles = css` :host{align-self: start;grid-row: 2;margin-top: -2px;height: calc((${heightNumber} / 2 + ${designUnit}) * 1px);width: auto}.container{grid-template-rows: auto auto;grid-template-columns: 0}.label{margin: 2px 0}`;
/**
 * Styles for Vertical slider label
 * @public
 */
const verticalSliderLabelStyles = css` :host{justify-self: start;grid-column: 2;margin-left: 2px;height: auto;width: calc((${heightNumber} / 2 + ${designUnit}) * 1px)}.container{grid-template-columns: auto auto;grid-template-rows: 0;min-width: calc(var(--thumb-size) * 1px);height: calc(var(--thumb-size) * 1px)}.mark{transform: rotate(90deg);align-self: center}.label{margin-left: calc((${designUnit} / 2) * 3px);align-self: center}`;
/**
 ...
 */''} user-select: none}:host([disabled]){opacity: ${disabledOpacity}}:host([disabled]) .label, :host([readonly]) .label, :host([readonly]) .switch, :host([disabled]) .switch{cursor: ${disabledCursor}}.switch{position: relative;outline: none;box-sizing: border-box;width: calc(${heightNumber} * 1px);height: calc((${heightNumber} / 2 + ${designUnit}) * 1px);background: ${neutralFillInputRest};border-radius: calc(${controlCornerRadius} * 1px);border: calc(${strokeWidth} * 1px) solid ${neutralStrokeRest}}:host([aria-invalid='true']) .switch{border-color: ${errorFillRest}}.switch:hover{background: ${neutralFillInputHover};border-color: ${neutralStrokeHover};cursor: pointer}:host([disabled]) .switch:hover, :host([readonly]) .switch:hover{background: ${neutralFillInputHover};border-color: ${neutralStrokeHover};cursor: ${disabledCursor}}:host([aria-invalid='true'][disabled]) .switch:hover, :host([aria-invalid='true'][readonly]) .switch:hover{border-color: ${errorFillHover}}:host(:not([disabled])) .switch:active{background: ${neutralFillInputActive};border-color: ${neutralStrokeActive}}:host([aria-invalid='true']:not([disabled])) .switch:active{border-color: ${errorFillActive}}:host(:${focusVisible}) .switch{outline-offset: 2px;outline: solid calc(${focusStrokeWidth} * 1px) ${accentFillFocus}}:host([aria-invalid='true']:${focusVisible}) .switch{outline-color: ${errorFillFocus}}.checked-indicator{position: absolute;top: 5px;bottom: 5px;background: ${neutralForegroundRest};border-radius: calc(${controlCornerRadius} * 1px);transition: all 0.2s ease-in-out}.status-message{color: ${neutralForegroundRest};cursor: pointer;font-size: ${typeRampBaseFontSize};line-height: ${typeRampBaseLineHeight}}:host([disabled]) .status-message, :host([readonly]) .status-message{cursor: ${disabledCursor}}.label{color: ${neutralForegroundRest};margin-inline-end: calc(${designUnit} * 2px + 2px);font-size: ${typeRampBaseFontSize};line-height: ${typeRampBaseLineHeight};cursor: pointer}.label__hidden{display: none;visibility: hidden}::slotted([slot='checked-message']), ::slotted([slot='unchecked-message']){margin-inline-start: calc(${designUnit} * 2px + 2px)}:host([aria-checked='true']) .checked-indicator{background: ${foregroundOnAccentRest}}:host([aria-checked='true']) .switch{background: ${accentFillRest};border-color: ${accentFillRest}}:host([aria-checked='true']:not([disabled])) .switch:hover{background: ${accentFillHover};border-color: ${accentFillHover}}:host([aria-invalid='true'][aria-checked='true']) .switch{background-color: ${errorFillRest};border-color: ${errorFillRest}}:host([aria-invalid='true'][aria-checked='true']:not([disabled])) .switch:hover{background-color: ${errorFillHover};border-color: ${errorFillHover}}:host([aria-checked='true']:not([disabled])) .switch:hover .checked-indicator{background: ${foregroundOnAccentHover}}:host([aria-checked='true']:not([disabled])) .switch:active{background: ${accentFillActive};border-color: ${accentFillActive}}:host([aria-invalid='true'][aria-checked='true']:not([disabled])) .switch:active{background-color: ${errorFillActive};border-color: ${errorFillActive}}:host([aria-checked='true']:not([disabled])) .switch:active .checked-indicator{background: ${foregroundOnAccentActive}}:host([aria-checked="true"]:${focusVisible}:not([disabled])) .switch{outline: solid calc(${focusStrokeWidth} * 1px) ${accentFillFocus}}:host([aria-invalid='true'][aria-checked="true"]:${focusVisible}:not([disabled])) .switch{outline-color: ${errorFillFocus}}.unchecked-message{display: block}.checked-message{display: none}:host([aria-checked='true']) .unchecked-message{display: none}:host([aria-checked='true']) .checked-message{display: block}`.withBehaviors(forcedColorsStylesheetBehavior(css` .checked-indicator, :host(:not([disabled])) .switch:active .checked-indicator{forced-color-adjust: none;background: ${SystemColors.FieldText}}.switch{forced-color-adjust: none;background: ${SystemColors.Field};border-color: ${SystemColors.FieldText}}:host([aria-invalid='true']) .switch{border-style: dashed}:host(:not([disabled])) .switch:hover{background: ${SystemColors.HighlightText};border-color: ${SystemColors.Highlight}}:host([aria-checked='true']) .switch{background: ${SystemColors.Highlight};border-color: ${SystemColors.Highlight}}:host([aria-checked='true']:not([disabled])) .switch:hover, :host(:not([disabled])) .switch:active{background: ${SystemColors.HighlightText};border-color: ${SystemColors.Highlight}}:host([aria-checked='true']) .checked-indicator{background: ${SystemColors.HighlightText}}:host([aria-checked='true']:not([disabled])) .switch:hover .checked-indicator{background: ${SystemColors.Highlight}}:host([disabled]){opacity: 1}:host(:${focusVisible}) .switch{border-color: ${SystemColors.Highlight};outline-offset: 2px;outline: solid calc(${focusStrokeWidth} * 1px) ${SystemColors.FieldText}}:host([aria-checked="true"]:${focusVisible}:not([disabled])) .switch{outline: solid calc(${focusStrokeWidth} * 1px) ${SystemColors.FieldText}}:host([disabled]) .checked-indicator{background: ${SystemColors.GrayText}}:host([disabled]) .switch{background: ${SystemColors.Field};border-color: ${SystemColors.GrayText}}`), new DirectionalStyleSheetBehavior(css` .checked-indicator{left: 5px;right: calc(((${heightNumber} / 2) + 1) * 1px)}:host([aria-checked='true']) .checked-indicator{left: calc(((${heightNumber} / 2) + 1) * 1px);right: 5px}`, css` .checked-indicator{right: 5px;left: calc(((${heightNumber} / 2) + 1) * 1px)}:host([aria-checked='true']) .checked-indicator{right: calc(((${heightNumber} / 2) + 1) * 1px);left: 5px}`));
 ...
 * @public
 */
const tabPanelStyles = (context, definition) => css` ${display('block')} :host{box-sizing: border-box;font-size: ${typeRampBaseFontSize};line-height: ${typeRampBaseLineHeight};padding: 0 calc((6 + (${designUnit} * 2 * ${density})) * 1px)}`;
 ...
 * @public
 */
const textAreaStyles = (context, definition) => css` ${display('inline-block')} :host{font-family: ${bodyFont};outline: none;user-select: none}.control{box-sizing: border-box;position: relative;color: ${neutralForegroundRest};background: ${neutralFillInputRest};border-radius: calc(${controlCornerRadius} * 1px);border: calc(${strokeWidth} * 1px) solid ${neutralFillStrongRest};height: calc(${heightNumber} * 2px);font: inherit;font-size: ${typeRampBaseFontSize};line-height: ${typeRampBaseLineHeight};padding: calc(${designUnit} * 2px + 1px);width: 100%;resize: none}:host([aria-invalid='true']) .control{border-color: ${errorFillRest}}.control:hover:enabled{background: ${neutralFillInputHover};border-color: ${neutralFillStrongHover}}:host([aria-invalid='true']) .control:hover:enabled{border-color: ${errorFillHover}}.control:active:enabled{background: ${neutralFillInputActive};border-color: ${neutralFillStrongActive}}:host([aria-invalid='true']) .control:active:enabled{border-color: ${errorFillActive}}.control:hover, .control:${focusVisible}, .control:disabled, .control:active{outline: none}:host(:focus-within) .control{border-color: ${accentFillFocus};box-shadow: 0 0 0 calc((${focusStrokeWidth} - ${strokeWidth}) * 1px) ${accentFillFocus}}:host([aria-invalid='true']:focus-within) .control{border-color: ${errorFillFocus};box-shadow: 0 0 0 calc((${focusStrokeWidth} - ${strokeWidth}) * 1px) ${errorFillFocus}}:host([appearance='filled']) .control{background: ${neutralFillRest}}:host([appearance='filled']:hover:not([disabled])) .control{background: ${neutralFillHover}}:host([resize='both']) .control{resize: both}:host([resize='horizontal']) .control{resize: horizontal}:host([resize='vertical']) .control{resize: vertical}.label{display: block;color: ${neutralForegroundRest};cursor: pointer;font-size: ${typeRampBaseFontSize};line-height: ${typeRampBaseLineHeight};margin-bottom: 4px}.label__hidden{display: none;visibility: hidden}:host([disabled]) .label, :host([readonly]) .label, :host([readonly]) .control, :host([disabled]) .control{cursor: ${disabledCursor}}:host([disabled]){opacity: ${disabledOpacity}}:host([disabled]) .control{border-color: ${neutralStrokeRest}}:host([cols]){width: initial}:host([rows]) .control{height: initial}`.withBehaviors(forcedColorsStylesheetBehavior(css` :host([disabled]){opacity: 1}:host([aria-invalid='true']) .control{border-style: dashed}`));
...
__decorate([attr], JupyterTextArea.prototype, "appearance", void 0);
/**
 ...
 * @public
 */
const textFieldStyles = (context, definition) => css` ${BaseFieldStyles} .start, .end{display: flex}`;
...
__decorate([attr], JupyterTextField.prototype, "appearance", void 0);
/**
...
__decorate([observable], FoundationToolbar.prototype, "direction", void 0);
__decorate([attr], FoundationToolbar.prototype, "orientation", void 0);
__decorate([observable], FoundationToolbar.prototype, "slottedItems", void 0);
__decorate([observable], FoundationToolbar.prototype, "slottedLabel", void 0);
__decorate([observable], FoundationToolbar.prototype, "childItems", void 0);
/**
...
const ltr = css` .expand-collapse-glyph{transform: rotate(0deg)}:host(.nested) .expand-collapse-button{left: var( --expand-collapse-button-nested-width, calc( ( ${expandCollapseButtonSize} + ((${baseHeightMultiplier} + ${density}) * 1.25) ) * -1px ) )}:host([selected])::after{left: calc(${focusStrokeWidth} * 1px)}:host([expanded]) > .positioning-region .expand-collapse-glyph{transform: rotate(90deg)}`;
const rtl = css` .expand-collapse-glyph{transform: rotate(180deg)}:host(.nested) .expand-collapse-button{right: var( --expand-collapse-button-nested-width, calc( ( ${expandCollapseButtonSize} + ((${baseHeightMultiplier} + ${density}) * 1.25) ) * -1px ) )}:host([selected])::after{right: calc(${focusStrokeWidth} * 1px)}:host([expanded]) > .positioning-region .expand-collapse-glyph{transform: rotate(90deg)}`;
 ...
 * @public
 */
const treeItemStyles = (context, definition) => css` /** * This animation exists because when tree item children are conditionally loaded * there is a visual bug where the DOM exists but styles have not yet been applied (essentially FOUC). * This subtle animation provides a ever so slight timing adjustment for loading that solves the issue. */ @keyframes treeItemLoading{0%{opacity: 0}100%{opacity: 1}}${display('block')} :host{contain: content;position: relative;outline: none;color: ${neutralForegroundRest};background: ${neutralFillStealthRest};cursor: pointer;font-family: ${bodyFont};--tree-item-nested-width: 0}:host(:focus) > .positioning-region{outline: none}:host(:focus) .content-region{outline: none}:host(:${focusVisible}) .positioning-region{border-color: ${accentFillFocus};box-shadow: 0 0 0 calc((${focusStrokeWidth} - ${strokeWidth}) * 1px) ${accentFillFocus} inset;color: ${neutralForegroundRest}}.positioning-region{display: flex;position: relative;box-sizing: border-box;background: ${neutralFillStealthRest};border: transparent calc(${strokeWidth} * 1px) solid;border-radius: calc(${controlCornerRadius} * 1px);height: calc((${heightNumber} + 1) * 1px)}.positioning-region::before{content: '';display: block;width: var(--tree-item-nested-width);flex-shrink: 0}:host(:not([disabled])) .positioning-region:hover{background: ${neutralFillStealthHover}}:host(:not([disabled])) .positioning-region:active{background: ${neutralFillStealthActive}}.content-region{display: inline-flex;align-items: center;white-space: nowrap;width: 100%;min-width: 0;height: calc(${heightNumber} * 1px);margin-inline-start: calc(${designUnit} * 2px + 8px);font-size: ${typeRampBaseFontSize};line-height: ${typeRampBaseLineHeight};font-weight: 400}.items{/* TODO: adaptive typography https://github.com/microsoft/fast/issues/2432 */ font-size: calc(1em + (${designUnit} + 16) * 1px)}.expand-collapse-button{background: none;border: none;outline: none;/* TODO: adaptive typography https://github.com/microsoft/fast/issues/2432 */ width: calc(${expandCollapseButtonSize} * 1px);height: calc(${expandCollapseButtonSize} * 1px);padding: 0;display: flex;justify-content: center;align-items: center;cursor: pointer;margin-left: 6px;margin-right: 6px}.expand-collapse-glyph{/* TODO: adaptive typography https://github.com/microsoft/fast/issues/2432 */ width: calc((16 + ${density}) * 1px);height: calc((16 + ${density}) * 1px);transition: transform 0.1s linear;pointer-events: none;fill: currentcolor}.start, .end{display: flex;fill: currentcolor}::slotted(svg){/* TODO: adaptive typography https://github.com/microsoft/fast/issues/2432 */ width: 16px;height: 16px;/* Something like that would do if the typography is adaptive font-size: inherit;width: ${typeRampPlus1FontSize};height: ${typeRampPlus1FontSize};*/}.start{/* TODO: horizontalSpacing https://github.com/microsoft/fast/issues/2766 */ margin-inline-end: calc(${designUnit} * 2px + 2px)}.end{/* TODO: horizontalSpacing https://github.com/microsoft/fast/issues/2766 */ margin-inline-start: calc(${designUnit} * 2px + 2px)}:host([expanded]) > .items{animation: treeItemLoading ease-in 10ms;animation-iteration-count: 1;animation-fill-mode: forwards}:host([disabled]) .content-region{opacity: ${disabledOpacity};cursor: ${disabledCursor}}:host(.nested) .content-region{position: relative;/* Add left margin to collapse button size */ margin-inline-start: calc( ( ${expandCollapseButtonSize} + ((${baseHeightMultiplier} + ${density}) * 1.25) ) * 1px )}:host(.nested) .expand-collapse-button{position: absolute}:host(.nested:not([disabled])) .expand-collapse-button:hover{background: ${expandCollapseHoverBehavior}}:host([selected]) .positioning-region{background: ${neutralFillRest}}:host([selected]:not([disabled])) .positioning-region:hover{background: ${neutralFillHover}}:host([selected]:not([disabled])) .positioning-region:active{background: ${neutralFillActive}}:host([selected]:not([disabled])) .expand-collapse-button:hover{background: ${selectedExpandCollapseHoverBehavior}}:host([selected])::after{/* The background needs to be calculated based on the selected background state for this control. We currently have no way of changing that, so setting to accent-foreground-rest for the time being */ background: ${accentForegroundRest};border-radius: calc(${controlCornerRadius} * 1px);content: '';display: block;position: absolute;top: calc((${heightNumber} / 4) * 1px);width: 3px;height: calc((${heightNumber} / 2) * 1px)}::slotted(${context.tagFor(TreeItem)}){--tree-item-nested-width: 1em;--expand-collapse-button-nested-width: calc( ( ${expandCollapseButtonSize} + ((${baseHeightMultiplier} + ${density}) * 1.25) ) * -1px )}`.withBehaviors(new DirectionalStyleSheetBehavior(ltr, rtl), forcedColorsStylesheetBehavior(css` :host{forced-color-adjust: none;border-color: transparent;background: ${SystemColors.Field};color: ${SystemColors.FieldText}}:host .content-region .expand-collapse-glyph{fill: ${SystemColors.FieldText}}:host .positioning-region:hover, :host([selected]) .positioning-region{background: ${SystemColors.Highlight}}:host .positioning-region:hover .content-region, :host([selected]) .positioning-region .content-region{color: ${SystemColors.HighlightText}}:host .positioning-region:hover .content-region .expand-collapse-glyph, :host .positioning-region:hover .content-region .start, :host .positioning-region:hover .content-region .end, :host([selected]) .content-region .expand-collapse-glyph, :host([selected]) .content-region .start, :host([selected]) .content-region .end{fill: ${SystemColors.HighlightText}}:host([selected])::after{background: ${SystemColors.Field}}:host(:${focusVisible}) .positioning-region{border-color: ${SystemColors.FieldText};box-shadow: 0 0 0 2px inset ${SystemColors.Field};color: ${SystemColors.FieldText}}:host([disabled]) .content-region, :host([disabled]) .positioning-region:hover .content-region{opacity: 1;color: ${SystemColors.GrayText}}:host([disabled]) .content-region .expand-collapse-glyph, :host([disabled]) .content-region .start, :host([disabled]) .content-region .end, :host([disabled]) .positioning-region:hover .content-region .expand-collapse-glyph, :host([disabled]) .positioning-region:hover .content-region .start, :host([disabled]) .positioning-region:hover .content-region .end{fill: ${SystemColors.GrayText}}:host([disabled]) .positioning-region:hover{background: ${SystemColors.Field}}.expand-collapse-glyph, .start, .end{fill: ${SystemColors.FieldText}}:host(.nested) .expand-collapse-button:hover{background: ${SystemColors.Field}}:host(.nested) .expand-collapse-button:hover .expand-collapse-glyph{fill: ${SystemColors.FieldText}}`));
 ...
 * @public
 */
const treeViewStyles = (context, definition) => css` ${display('flex')} :host{flex-direction: column;align-items: stretch;min-width: fit-content;font-size: 0}:host:focus-visible{outline: none}`;
    ...
    converter: (value, isDark) => {
      ...
      if (parsedColor) {
        ...
        const correctedHSL = ColorHSL.fromObject({
          h: hsl.h,
          s: hsl.s,
          l: hsl.l + direction * accentFillHoverDelta.getValueFor(document.body) / 94.0
        });
        const correctedRGB = hslToRGB(correctedHSL);
        return SwatchRGB.create(correctedRGB.r, correctedRGB.g, correctedRGB.b);
      } else {
 ...
 */
const JupyterDesignSystem = provideJupyterDesignSystem().register(allComponents);

export { JupyterAccordion as Accordion, JupyterAccordionItem as AccordionItem, JupyterAnchor as Anchor, JupyterAnchoredRegion as AnchoredRegion, JupyterAvatar as Avatar, JupyterBadge as Badge, JupyterBreadcrumb as Breadcrumb, JupyterBreadcrumbItem as BreadcrumbItem, JupyterButton as Button, JupyterCard as Card, JupyterCheckbox as Checkbox, JupyterCombobox as Combobox, JupyterDataGrid as DataGrid, JupyterDataGridCell as DataGridCell, JupyterDataGridRow as DataGridRow, DateField, DelegatesARIAToolbar, DesignSystemProvider, JupyterDialog as Dialog, DirectionalStyleSheetBehavior, JupyterDisclosure as Disclosure, JupyterDivider as Divider, FoundationToolbar, JupyterDesignSystem, JupyterListbox as Listbox, JupyterMenu as Menu, JupyterMenuItem as MenuItem, JupyterNumberField as NumberField, JupyterOption as Option, PaletteRGB, JupyterPicker as Picker, JupyterPickerList as PickerList, JupyterPickerListItem as PickerListItem, JupyterPickerMenu as PickerMenu, JupyterPickerMenuOption as PickerMenuOption, JupyterProgress as Progress, JupyterProgressRing as ProgressRing, JupyterRadio as Radio, JupyterRadioGroup as RadioGroup, JupyterSearch as Search, JupyterSelect as Select, JupyterSkeleton as Skeleton, JupyterSlider as Slider, JupyterSliderLabel as SliderLabel, StandardLuminance, SwatchRGB, JupyterSwitch as Switch, JupyterTab as Tab, JupyterTabPanel as TabPanel, JupyterTabs as Tabs, JupyterTextArea as TextArea, JupyterTextField as TextField, Toolbar, JupyterTooltip as Tooltip, JupyterTreeItem as TreeItem, JupyterTreeView as TreeView, accentColor, accentFillActive, accentFillActiveDelta, accentFillFocus, accentFillFocusDelta, accentFillHover, accentFillHoverDelta, accentFillRecipe, accentFillRest, accentFillRestDelta, accentForegroundActive, accentForegroundActiveDelta, accentForegroundFocus, accentForegroundFocusDelta, accentForegroundHover, accentForegroundHoverDelta, accentForegroundRecipe, accentForegroundRest, accentForegroundRestDelta, accentPalette, accordionItemStyles, accordionStyles, addJupyterLabThemeChangeListener, allComponents, anchorStyles, anchoredRegionStyles, applyJupyterTheme, avatarStyles, badgeStyles, baseHeightMultiplier, baseHorizontalSpacingMultiplier, baseLayerLuminance, bodyFont, breadcrumbItemStyles, breadcrumbStyles, buttonStyles, cardStyles, checkboxStyles, checkboxTemplate, comboboxStyles, controlCornerRadius, dataGridCellStyles, dataGridRowStyles, dataGridStyles, dateFieldStyles, dateFieldTemplate, density, designSystemProviderStyles, designSystemProviderTemplate, designUnit, dialogStyles, direction, disabledOpacity, disclosureStyles, dividerStyles, elementScale, errorColor, errorFillActive, errorFillFocus, errorFillHover, errorFillRecipe, errorFillRest, errorForegroundActive, errorForegroundFocus, errorForegroundHover, errorForegroundRecipe, errorForegroundRest, errorPalette, fillColor, focusStrokeInner, focusStrokeInnerRecipe, focusStrokeOuter, focusStrokeOuterRecipe, focusStrokeWidth, foregroundOnAccentActive, foregroundOnAccentActiveLarge, foregroundOnAccentFocus, foregroundOnAccentFocusLarge, foregroundOnAccentHover, foregroundOnAccentHoverLarge, foregroundOnAccentLargeRecipe, foregroundOnAccentRecipe, foregroundOnAccentRest, foregroundOnAccentRestLarge, foregroundOnErrorActive, foregroundOnErrorActiveLarge, foregroundOnErrorFocus, foregroundOnErrorFocusLarge, foregroundOnErrorHover, foregroundOnErrorHoverLarge, foregroundOnErrorLargeRecipe, foregroundOnErrorRecipe, foregroundOnErrorRest, foregroundOnErrorRestLarge, heightNumberAsToken, horizontalSliderLabelStyles, imgTemplate, isDark, jpAccordion, jpAccordionItem, jpAnchor, jpAnchoredRegion, jpAvatar, jpBadge, jpBreadcrumb, jpBreadcrumbItem, jpButton, jpCard, jpCheckbox, jpCombobox, jpDataGrid, jpDataGridCell, jpDataGridRow, jpDateField, jpDesignSystemProvider, jpDialog, jpDisclosure, jpDivider, jpListbox, jpMenu, jpMenuItem, jpNumberField, jpOption, jpPicker, jpPickerList, jpPickerListItem, jpPickerMenu, jpPickerMenuOption, jpProgress, jpProgressRing, jpRadio, jpRadioGroup, jpSearch, jpSelect, jpSkeleton, jpSlider, jpSliderLabel, jpSwitch, jpTab, jpTabPanel, jpTabs, jpTextArea, jpTextField, jpToolbar, jpTooltip, jpTreeItem, jpTreeView, listboxStyles, menuItemStyles, menuStyles, neutralColor, neutralFillActive, neutralFillActiveDelta, neutralFillFocus, neutralFillFocusDelta, neutralFillHover, neutralFillHoverDelta, neutralFillInputActive, neutralFillInputActiveDelta, neutralFillInputFocus, neutralFillInputFocusDelta, neutralFillInputHover, neutralFillInputHoverDelta, neutralFillInputRecipe, neutralFillInputRest, neutralFillInputRestDelta, neutralFillLayerRecipe, neutralFillLayerRest, neutralFillLayerRestDelta, neutralFillRecipe, neutralFillRest, neutralFillRestDelta, neutralFillStealthActive, neutralFillStealthActiveDelta, neutralFillStealthFocus, neutralFillStealthFocusDelta, neutralFillStealthHover, neutralFillStealthHoverDelta, neutralFillStealthRecipe, neutralFillStealthRest, neutralFillStealthRestDelta, neutralFillStrongActive, neutralFillStrongActiveDelta, neutralFillStrongFocus, neutralFillStrongFocusDelta, neutralFillStrongHover, neutralFillStrongHoverDelta, neutralFillStrongRecipe, neutralFillStrongRest, neutralFillStrongRestDelta, neutralForegroundHint, neutralForegroundHintRecipe, neutralForegroundRecipe, neutralForegroundRest, neutralLayer1, neutralLayer1Recipe, neutralLayer2, neutralLayer2Recipe, neutralLayer3, neutralLayer3Recipe, neutralLayer4, neutralLayer4Recipe, neutralLayerCardContainer, neutralLayerCardContainerRecipe, neutralLayerFloating, neutralLayerFloatingRecipe, neutralPalette, neutralStrokeActive, neutralStrokeActiveDelta, neutralStrokeDividerRecipe, neutralStrokeDividerRest, neutralStrokeDividerRestDelta, neutralStrokeFocus, neutralStrokeFocusDelta, neutralStrokeHover, neutralStrokeHoverDelta, neutralStrokeRecipe, neutralStrokeRest, neutralStrokeRestDelta, numberFieldStyles, optionStyles, pickerListItemStyles, pickerMenuOptionStyles, pickerMenuStyles, pickerStyles, progressRingStyles, progressStyles, provideJupyterDesignSystem, radioGroupStyles, radioStyles, radioTemplate, searchStyles, selectStyles, skeletonStyles, sliderLabelStyles, sliderStyles, strokeWidth, switchStyles, tabPanelStyles, tabStyles, tabsStyles, textAreaStyles, textFieldStyles, toolbarStyles, tooltipStyles, treeItemStyles, treeViewStyles, typeRampBaseFontSize, typeRampBaseLineHeight, typeRampMinus1FontSize, typeRampMinus1LineHeight, typeRampMinus2FontSize, typeRampMinus2LineHeight, typeRampPlus1FontSize, typeRampPlus1LineHeight, typeRampPlus2FontSize, typeRampPlus2LineHeight, typeRampPlus3FontSize, typeRampPlus3LineHeight, typeRampPlus4FontSize, typeRampPlus4LineHeight, typeRampPlus5FontSize, typeRampPlus5LineHeight, typeRampPlus6FontSize, typeRampPlus6LineHeight, verticalSliderLabelStyles };
