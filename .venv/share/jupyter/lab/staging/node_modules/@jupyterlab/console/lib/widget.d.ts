...
export declare class CodeConsole extends Widget {
     ...
     */
    private _setManualResize;
    /**
     * Cancel any pending resize adjustment animation frame.
     */
    private _cancelPendingResizeAdjustment;
    /**
    ...
    private _translator;
    private _splitPanel;
    private _promptResizeObserver;
    private _hasManualResize;
    private _resizeAnimationFrameId;
}
/**
...
export declare namespace CodeConsole {
     ...
     */
    type PromptCellPosition = 'top' | 'bottom' | 'left' | 'right';
    /**
