...
export declare namespace Commands {
     ...
     */
    function addCommands(commands: CommandRegistry, settingRegistry: ISettingRegistry, trans: TranslationBundle, id: string, isEnabled: () => boolean, tracker: WidgetTracker<IDocumentWidget<FileEditor>>, defaultBrowser: IDefaultFileBrowser | null, extensions: IEditorExtensionRegistry, languages: IEditorLanguageRegistry, consoleTracker: IConsoleTracker | null, sessionDialogs: ISessionContextDialogs, shell: JupyterFrontEnd.IShell): void;
     ...
     */
    function addKernelLanguageLauncherItems(launcher: ILauncher, trans: TranslationBundle, availableKernelFileTypes: Iterable<IRenderMime.IFileType>): IDisposable;
    /**
     ...
     * Returns a DisposableSet containing all added items
     */
    function addKernelLanguagePaletteItems(palette: ICommandPalette, trans: TranslationBundle, availableKernelFileTypes: Iterable<IRenderMime.IFileType>): IDisposable;
    /**
     ...
     * Returns a DisposableSet containing all added items
     */
    function addKernelLanguageMenuItems(menu: IMainMenu, trans: TranslationBundle, availableKernelFileTypes: Iterable<IRenderMime.IFileType>): IDisposable;
    /**
