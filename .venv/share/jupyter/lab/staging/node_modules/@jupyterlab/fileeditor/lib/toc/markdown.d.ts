...
export declare class MarkdownTableOfContentsModel extends TableOfContentsModel<IEditorHeading, IDocumentWidget<FileEditor, DocumentRegistry.IModel>> {
    ...
    constructor(widget: IDocumentWidget<FileEditor>, configuration?: TableOfContents.IConfig | undefined, parser?: IMarkdownParser | null);
    /**
...
export declare class MarkdownTableOfContentsFactory extends EditorTableOfContentsFactory {
    protected parser: IMarkdownParser | null;
    constructor(tracker: WidgetTracker<IDocumentWidget<FileEditor>>, parser?: IMarkdownParser | null);
    /**
