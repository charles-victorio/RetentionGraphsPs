...
export declare namespace CommandIDs {
    ...
    const minimap = "viewmenu:show-minimap";
    ...
    const getKernel = "helpmenu:get-kernel";
    const openFirst = "mainmenu:open-first";
}
declare const _default: (JupyterFrontEndPlugin<void> | JupyterFrontEndPlugin<IMainMenu>)[];
