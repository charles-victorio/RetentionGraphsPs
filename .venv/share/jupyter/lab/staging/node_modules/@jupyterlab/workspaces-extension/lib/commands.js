            ...
            describedBy: {
                args: {
                    ...
                    properties: {
                        workspace: {
                            type: 'string',
                            description: trans.__('Workspace identifier for the new workspace')
                        }
                    }
                }
            }
            ...
            execute: async () => {
                ...
                const result = await FileDialog.getOpenFiles({
                    ...
                    filter: (model) => model.type === 'directory' || model.path.endsWith(WORKSPACE_EXT)
                        ? {}
                        : null,
                    label: trans.__('Choose one or more workspace files to import. A Jupyter workspace file has the extension "%1".', WORKSPACE_EXT),
                    translator
                });
