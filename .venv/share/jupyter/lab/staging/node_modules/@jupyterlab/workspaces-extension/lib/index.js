...
import { ICommandPalette, IToolbarWidgetRegistry, IWindowResolver } from '@jupyterlab/apputils';
...
const workspacesIndicator = {
    ...
    autoStart: true,
    activate: async (app, model, commands, resolver, translator, registry, toolbarRegistry, palette) => {
